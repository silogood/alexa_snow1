    ...
    public Handler handle = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch(message) {
                ...
                case MSG_WWE_ALEXA:
                    //Broadcast
                    updateLog("----> SEND BROADCAST ALEXA" ,"green");
                    Intent intent_alexa = new Intent("ai.kitt.snowboy.demo.WWE");
                    intent_alexa.setComponent(new ComponentName("com.innopia.alexastartservice", "com.innopia.alexastartservice.WweReceiver"));
                    intent_alexa.putExtra("WWE","ALEXA");
                    intent_alexa.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
                    getApplicationContext().sendBroadcast(intent_alexa);
                    break;
                case MSG_WWE_COMPUTER:
                    //Broadcast
                    updateLog("----> SEND BROADCAST COMPUTER","green");
                    //Broadcast
                    Intent intent_computer = new Intent("ai.kitt.snowboy.demo.WWE");
                    intent_computer.setComponent(new ComponentName("com.innopia.alexastartservice", "com.innopia.alexastartservice.WweReceiver"));
                    intent_computer.putExtra("WWE","COMPUTER");
                    intent_computer.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
                    getApplicationContext().sendBroadcast(intent_computer);
                    break;
                default:
